...
.stApp { background: #0A0F1C !important; } /* Deep Slate */

/* Unhide the header so the sidebar toggle (>) works */
#MainMenu, footer { visibility: hidden; }
header { background: transparent !important; }

::-webkit-scrollbar { width: 5px; }
::-webkit-scrollbar-track { background: #0A0F1C; }
::-webkit-scrollbar-thumb { background: #0F766E; border-radius: 4px; } /* Teal */

/* ===== SIDEBAR ===== */
section[data-testid="stSidebar"] {
    background: #0F1525 !important; /* Slightly lighter slate */
...
div[data-testid="stMetric"] {
    ...
    border-radius: 8px; /* Sharper corners for finance */
    padding: 18px 14px;
...
div[data-testid="stMetric"] [data-testid="stMetricValue"] {
    color: #F3F4F6 !important; /* Crisp White */
...
.stTabs [aria-selected="true"] {
    background: #0F766E !important; /* Institutional Teal */
...
.brand-text { color: #F3F4F6; font-size: 0.95rem; font-weight: 600; letter-spacing: 0.5px; }
.brand-sub { color: #D97706; /* Gold */ font-size: 0.65rem; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; }

.nav-section { color: #6B7280; font-size: 0.65rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin: 24px 0 8px 0; padding: 0 4px; }
...
.stat-label { color: #9CA3AF; font-size: 0.7rem; font-weight: 500; flex: 1; }
.stat-value { color: #F3F4F6; font-size: 0.75rem; font-weight: 600; }
...
.page-title { color: #F3F4F6; font-size: 1.4rem; font-weight: 600; letter-spacing: 0.5px; }
.page-badge {
    background: rgba(15, 118, 110, 0.15);
    border: 1px solid #0F766E;
    color: #14B8A6; font-size: 0.65rem; font-weight: 600;
...
.card-title {
    color: #F3F4F6; font-size: 0.9rem; font-weight: 600; letter-spacing: 0.5px;
    margin-bottom: 4px; display: flex; align-items: center; gap: 8px;
}
.card-desc { color: #9CA3AF; font-size: 0.75rem; font-weight: 400; margin-bottom: 16px; }

.info-banner {
    background: rgba(15, 118, 110, 0.08);
    border-left: 3px solid #0F766E;
    padding: 14px 18px;
    color: #D1D5DB; font-size: 0.8rem; line-height: 1.6;
    margin-bottom: 20px;
}
...
.footer-text { color: #6B7280; font-size: 0.65rem; font-weight: 500; letter-spacing: 1px; }
</style>
...
PLOTLY_LAYOUT = dict(
    ...
    hoverlabel=dict(bgcolor="#141B2D", font_size=12, font_family="Inter", bordercolor="#0F766E"),
)
# Finance Color Palette (Green, Yellow, Red)
