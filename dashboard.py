...
header[data-testid="stHeader"] {{
    ...
    background: {TH.BG_PRIMARY} !important;
...
/* ===== SIDEBAR TOGGLE — BIG BLACK BUTTON ===== */
/* Target EVERY possible sidebar button selector across all Streamlit versions */

/* Close button (when sidebar is OPEN) — top-right of sidebar */
section[data-testid="stSidebar"] button[kind="header"],
section[data-testid="stSidebar"] button[data-testid="stSidebarCollapseButton"],
section[data-testid="stSidebar"] > div > button,
section[data-testid="stSidebar"] > button,
section[data-testid="stSidebar"] header button {{
    background: {TH.TEXT_PRIMARY} !important;
...
/* Open button (when sidebar is COLLAPSED) — floating top-left */
