...
def page_executive_summary():
    ...
    <div class="data-source">
        <div class="data-source-title">Verified Data Source</div>
        <div class="data-source-text">
            <strong>Lending Club via Kaggle</strong> — real-world peer-to-peer lending data &nbsp;|&nbsp;
            <strong>30,000</strong> loan records &nbsp;|&nbsp;
            <strong>7 features</strong> (credit grade, interest rate, utilization, installment history) &nbsp;|&nbsp;
            Target: <strong>actual loan defaults</strong> (not synthetic)
        </div>
    </div>
    """, unsafe_allow_html=True)
