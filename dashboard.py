...
/* Unhide the header so the sidebar toggle (>) works, but hide standard toolbar icons */
#MainMenu, footer { visibility: hidden !important; }
header { background: transparent !important; }
[data-testid="stToolbar"] { visibility: hidden !important; }

/* Make sure the sidebar toggle icon is visible on the pitch black background */
