...
*:not(.material-symbols-rounded):not(.material-icons) {{ font-family: 'Inter', -apple-system, sans-serif !important; }}
...
header[data-testid="stHeader"] {{ background: {TH.BG_PRIMARY} !important; }}
...
def page_executive_summary():
    ...
    with tab1:
        ...
        with col_c:
            ...
            <div class="metric-card" style="height: 320px;">
                <div class="card-header">
                    <div class="card-title">Mean Default Probability</div>
                    <div class="card-subtitle">Average predicted default chance per risk tier</div>
                </div>
            """, unsafe_allow_html=True)
    ...
    with tab2:
        ...
        with col_left:
            ...
            <div class="metric-card">
                <div class="card-header">
                    <div class="card-title">Default Probability Distribution</div>
                    <div class="card-subtitle">Spread of predicted default probabilities across all loans</div>
                </div>
            """, unsafe_allow_html=True)
        ...
        with col_right:
            ...
            <div class="metric-card">
                <div class="card-header">
                    <div class="card-title">Interest Rate vs Default Probability</div>
                    <div class="card-subtitle">Relationship between loan pricing and predicted risk</div>
                </div>
            """, unsafe_allow_html=True)
    ...
    with tab3:
        ...
        <div class="metric-card">
            <div class="card-header">
                <div class="card-title">Borrower Segments</div>
                <div class="card-subtitle">Grouping borrowers by key features and comparing default patterns</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with tab4:
        ...
        <div class="metric-card">
            <div class="card-header">
                <div class="card-title">Risk Level Comparison</div>
                <div class="card-subtitle">Side-by-side stats for each risk group</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with tab1:
        ...
        <div class="metric-card">
            <div class="card-header">
                ...
                <div class="card-subtitle">How strongly each feature is related to every other feature</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with tab2:
        ...
        <div class="metric-card">
            <div class="card-header">
                ...
                <div class="card-subtitle">Which features have the strongest relationship with actual defaults</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with tab4:
        ...
        <div class="metric-card">
            <div class="card-header">
                ...
                <div class="card-subtitle">How well the model's predictions match actual default rates</div>
            </div>
        """, unsafe_allow_html=True)
...
def page_stress_testing():
    ...
    with tab1:
        ...
        with col_l:
            ...
            <div class="metric-card">
                <div class="card-header">
                    <div class="card-title">Normal Loss by Tier</div>
                    <div class="card-subtitle">Expected losses under current conditions</div>
                </div>
            """, unsafe_allow_html=True)
        ...
        with col_r:
            ...
            <div class="metric-card">
                <div class="card-header">
                    <div class="card-title">Stressed Loss by Tier</div>
                    <div class="card-subtitle">Expected losses under worst-case scenario</div>
                </div>
            """, unsafe_allow_html=True)
    ...
    with tab2:
        ...
        <div class="metric-card">
            <div class="card-header">
                <div class="card-title">Risk Tier Shifts</div>
                <div class="card-subtitle">How loans move between risk levels under stress</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with tab3:
        ...
        <div class="metric-card">
            <div class="card-header">
                ...
                <div class="card-subtitle">How losses change as risk multiplier increases</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with tab3:
        ...
        <div class="metric-card">
            <div class="card-header">
                ...
                <div class="card-subtitle">How these two features relate to each other</div>
            </div>
        """, unsafe_allow_html=True)
...
def main():
    ...
    st.sidebar.caption("Loan risk analysis platform powered by machine learning.")

    st.sidebar.markdown("**Technology**")
    st.sidebar.caption("• XGBoost ML model\n• Automated risk scoring\n• Interactive analytics")

    st.sidebar.markdown("**Status**")
    st.sidebar.caption(f"✓ System Online\n✓ Dataset: {len(df_master):,} loans\n✓ Last Updated: Today")
    ...
    <div style="text-align: center; padding: 40px 0; margin-top: 60px; border-top: 1px solid {TH.BORDER_LIGHT};">
        ...
        <p style="color: {TH.TEXT_MUTED}; font-size: 0.65rem; margin-top: 8px;">
            © {datetime.now().year} • Credit Risk Analytics • ML-Powered
        </p>
    </div>
    """, unsafe_allow_html=True)
