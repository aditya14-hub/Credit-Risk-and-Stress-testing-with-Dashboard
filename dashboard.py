...
*:not([class*="material"]):not([data-testid="collapsedControl"] span) {{ font-family: 'Inter', -apple-system, sans-serif !important; }}
[data-testid="collapsedControl"] span,
.material-symbols-rounded,
.material-icons {{ font-family: 'Material Symbols Rounded', 'Material Icons' !important; }}
