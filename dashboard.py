...
/* Sidebar toggle button — visible on all backgrounds */
...
def page_advanced_analytics():
    ...
    st.info("**Focus**: Evaluate model accuracy, compare algorithms, understand which features drive predictions, and verify calibration.")
