...
def train_xgb_model():
    """Train XGBoost on full data, compute SHAP on a representative sample."""
    ...
    return model, explainer, shap_values, X_sample, sample_idx
...
def page_explainability():
    ...
    model, explainer, shap_values, X_shap, sample_idx = train_xgb_model()
